...
export function ApprovalList({ role }: ApprovalListProps) {
  ...
  }, [approvals, searchTerm, role, statusFilter, sortField, sortDirection]);
  ...
  return (
    <div>
      ...
      {/* أدوات الفلترة */}
      {showFilters && (
        <div className="bg-white dark:bg-gray-900 rounded-lg border dark:border-gray-800 p-4 mb-6">
          ...
          <div className="overflow-x-auto">
            <div className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
              <div className="bg-gray-50 dark:bg-gray-900/50 border-b dark:border-gray-800 grid grid-cols-5 py-4">
                ...
                >
                  <span className="font-bold text-primary">الخطاب</span>
                  {sortField === 'subject' && (
                ...
                >
                  <span className="font-bold text-primary">تاريخ الطلب</span>
                      ...
                      <div className="px-4 flex items-center justify-center border-r dark:border-gray-700">
                        <div className="flex flex-col bg-gray-50 dark:bg-gray-800/50 px-3 py-1.5 rounded-lg">
                          <div className="flex items-center gap-1.5 text-sm text-gray-700 dark:text-gray-300 mb-0.5">
                            ...
                            <span className="font-medium">{new Date(requestDate).toLocaleDateString()}</span>
                          </div>
