/*
  # Fix permissions system for letters

  1. New Policies
    - Add proper RLS policies for letters table to enforce permissions
    - Ensure users can only view/edit/delete letters based on their permissions
  
  2. Security
    - Fix infinite recursion in user permissions policies
    - Improve permission checking for letter operations
*/
